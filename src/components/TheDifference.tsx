...
type PipelineStatus = 'complete' | 'running' | 'queued'
...
const STATUS_CFG: Record<PipelineStatus, StatusConfig> = {
...
function AgentWorkflow() {
  ...
  const totalMs = rows
    .filter(r => r.ms !== null)
    .reduce((a, r) => a + parseInt(r.ms as string, 10), 0)
    ...
    <div className="rounded-xl overflow-hidden border border-zinc-200 bg-white">
      ...
      <div className="px-4 py-2.5 border-t border-zinc-100 bg-zinc-50/50 flex items-center justify-between">
        <div className="flex items-center gap-4">
          <span className="text-[10px] font-mono text-zinc-400">latency: <span className="text-teal-600 font-semibold">42ms</span></span>
          <span className="text-[10px] font-mono text-zinc-400">status: <span className="text-teal-600 font-semibold">deterministic</span></span>
        </div>
        <div className="flex items-center gap-1.5">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-[11px] font-mono font-semibold uppercase tracking-widest text-zinc-400">Estado actual</span>
          ...
          >
            <div className="flex flex-col gap-1">
              <span className="text-[11px] font-mono font-semibold uppercase tracking-widest text-teal-600">Con Mole Engineering</span>
