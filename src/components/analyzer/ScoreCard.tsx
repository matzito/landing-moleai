...
export default function ScoreCard({ titulo, icono, datos }: ScoreCardProps) {
    ...
    <div className="glass-card rounded-2xl flex flex-col">
      ...
      <div className="px-5 pt-5 pb-4">
        <div className="flex items-start justify-between mb-3">
          <p className="text-[12px] font-black tracking-widest uppercase">{titulo}</p>
          <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 text-gray-700 -mt-0.5"
